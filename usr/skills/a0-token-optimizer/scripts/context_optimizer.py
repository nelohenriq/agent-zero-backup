...
STATE_FILE = Path.home() / "/a0/usr/memory/context-usage.json"
...
CONDITIONAL_FILES = {
    "/a0/prompts/agent.system.behaviour.md": ["workflow", "process", "how do i", "remember", "what should"],
    "/a0/prompts/agent.system.user.md": ["user", "human", "owner", "about you", "who are you helping"],
    "TOOLS.md": ["tool", "camera", "ssh", "voice", "tts", "device"],
    "/a0/prompts/agent.system.memory.md": ["remember", "recall", "history", "past", "before", "last time"],
...
def recommend_context_bundle(prompt, current_files=None):
    ...
    if context_level == "minimal":
        ...
        # Add /a0/prompts/agent.system.memory.md for long-term context
        recommended.add("/a0/prompts/agent.system.memory.md")
...
def generate_optimized_agents_md():
    """Generate an optimized /a0/prompts/agent.system.behaviour.md with lazy loading instructions.
    
    Returns:
        str with new /a0/prompts/agent.system.behaviour.md content
    """
    return """# /a0/prompts/agent.system.behaviour.md - Token-Optimized Workspace
...
1. Read `/a0/prompts/agent.system.main.role.md` — Who you are (identity/personality)
2. Read `/a0/prompts/agent.system.main.role.md` — Your role/name
...
- Load: /a0/prompts/agent.system.main.role.md, /a0/prompts/agent.system.main.role.md
- Skip: Everything else
- **Token savings: ~80%**

**Standard work request** (write code, check file):
- Load: /a0/prompts/agent.system.main.role.md, /a0/prompts/agent.system.main.role.md, memory/TODAY.md
- Conditionally load: TOOLS.md (if mentions tools)
- Skip: docs, old memory logs
- **Token savings: ~50%**

**Complex task** (design system, analyze history):
- Load: /a0/prompts/agent.system.main.role.md, /a0/prompts/agent.system.main.role.md, /a0/prompts/agent.system.memory.md, memory/TODAY.md, memory/YESTERDAY.md
...
**Long-term:** `/a0/prompts/agent.system.memory.md`
...
def main():
    ...
    if command == "recommend":
        ...
        output_path = Path.home() / "/a0/usr//a0/prompts/agent.system.behaviour.md.optimized"
        output_path.write_text(content)
        print(f"Generated optimized /a0/prompts/agent.system.behaviour.md at: {output_path}")
        print("\nReview and replace your current /a0/prompts/agent.system.behaviour.md with this version.")
