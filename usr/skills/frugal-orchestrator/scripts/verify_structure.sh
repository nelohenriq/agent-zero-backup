...
for dir in "${dirs[@]}"; do
 if [ -d "/a0/usr/projects/frugal-orchestrator/$dir" ]; then
...
grep -A 8 "## Delegation Patterns" /a0/usr/projects/frugal-orchestrator/SKILL.md 2>/dev/null || echo "SKILL.md not yet complete"
